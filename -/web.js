...
(function ($) {
    ...
    (function ($$) {
        ...
        function tg2_chart(chart_mode) {
            ...
            _atoms.m('checkboxes', ['columns'], (v) => {
                ...
                if (columns.length > 1) {
                    ...
                    for (var c = 0; c < columns.length; c++) {
                        ...
                        const name = columns[c].name;
                        const color = columns[c].color;
                        function updateCheckbox(c, checked) {
                        ...
                        const mousedown_checkbox = (event) => {
                            const target = (event.touches ? event.touches[0].target : event.currentTarget);
                            lastTarget = target;
                            ...
                            pressTimer[c] = setTimeout(() => {
                                ...
                                const new_alpha = Array(columns.length);
                                let changed = false;
                        ...
                        const mouseup_checkbox = (event) => {
                            const target = (event.touches ? lastTarget : event.currentTarget);
                            lastTarget = void 0;
                            const c = target.getAttribute('data-id');
                            if (!pressProcessed[c]) {
            ...
            _atoms.m('period', ['width', 'paddingHor', 'mainOffsetX', 'mainScaleX', 'intervalX'], (v) => {
                const width = v('width');
                const paddingHor = v('paddingHor');
